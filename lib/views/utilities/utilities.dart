...
class AppColors {
  static const Color primary = Color(0xFF6765C8); // AppColors.primary
  static const Color secondary = Color(0xFFAEAEB2); // AppColors.secondary
  static const Color secondary2 = Color(0xFF828282); // AppColors.secondary2
  ...
  static const Color black = Color(0xFF161C2A); // AppColors.black
