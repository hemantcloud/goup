...
class BasketSelected extends StatefulWidget {
  const BasketSelected({Key? key}) : super(key: key);

  @override
  State<BasketSelected> createState() => _BasketSelectedState();
}

class _BasketSelectedState extends State<BasketSelected> with TickerProviderStateMixin {
